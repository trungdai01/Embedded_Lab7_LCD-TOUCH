...
void generateFruit()
{
    ...
    lcd_DrawCircle(fruit_x_coord, fruit_y_coord, YELLOW, 6, 1);
...
void drawGameBoard()
{
    ...
    lcd_DrawRectangle(10, 10, 230, 220, WHITE);
...
void drawControlPad()
{
    ...
    lcd_Fill(50, 250, 90, 290, WHITE);
    strcpy(str, "L");
    lcd_ShowStr(64, 260, str, BLACK, CYAN, 24, 1);

    lcd_Fill(100, 230, 140, 270, WHITE);
    strcpy(str, "U");
    lcd_ShowStr(114, 240, str, BLACK, CYAN, 24, 1);

    lcd_Fill(100, 280, 140, 320, WHITE);
    strcpy(str, "D");
    lcd_ShowStr(114, 290, str, BLACK, CYAN, 24, 1);

    lcd_Fill(150, 250, 190, 290, WHITE);
    strcpy(str, "R");
    lcd_ShowStr(164, 260, str, BLACK, CYAN, 24, 1);
}
...
void printGameOver()
{
    ...
    lcd_ShowStr(65, 100, str, BLACK, RED, 24, 1);

    lcd_Fill(60, 180, 180, 230, BLACK);
    strcpy(str, "RESTART");
    lcd_ShowStr(80, 190, str, WHITE, BLACK, 24, 1);
}
